...
The clone harmfulness evaluator presented here is the replicable package of the approach described in paper 《Assessing Code Clone Harmfulness: Indicators, Factors, and Counter Measures》. The paper is published on IEEE SANER 2021.
